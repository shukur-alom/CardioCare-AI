...
'''it is essential to take immediate action by contacting a healthcare professional for confirmation and further evaluation. Follow the medical advice, which may include adjustments to medications, lifestyle changes, and possible hospitalization for monitoring. In the meantime, avoid physical exertion, maintain a healthy diet, manage stress, and monitor symptoms such as shortness of breath, fatigue, or swelling. Early intervention and proactive management can help reduce the severity of heart failure and improve overall outcomes.''',
'''it is important to seek immediate medical attention. Contact a healthcare provider or cardiologist to confirm the prediction and evaluate the condition. Based on their advice, follow prescribed treatments, which may include adjusting medications, lifestyle changes, and possibly hospitalization for closer monitoring. In the interim, limit physical activity, track symptoms such as shortness of breath, swelling, or chest pain, and maintain a healthy diet and fluid intake. Timely intervention and adherence to medical guidance are crucial for managing the condition and preventing further complications.''',
]
